...
test2="$url;&pseudo=$pseudobad;404"
test3="$url;&email=$email;401"
test4="$url;&pseudo=&email=$email;401"
test5="/login;&pseudo=$pseudo&password=$pass;200"
test6="$url;&pseudo=$pseudo&email=$email;401"
test7="/logout;&;200"
test8="$url;&pseudo=$pseudo&email=$email;200"
