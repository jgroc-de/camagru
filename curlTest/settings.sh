...
testb="$url;&pseudo=$pseudo&email=$email;401"
testa="login;&pseudo=test;200"
test0="$url;&;401"
test1="$url;&pseudo=$pseudo;401"
test1a="$url;&pseudo=$pseudo&email=$email;401"
test1b="$url;&email=$email;401"
test2="$url;&pseudo=$pseudo;401"
test3="$url;&alert:;401"
test3a="$url;&email=$email;401"
test4="$url;&pseudo=&email=$email;401"
test5="$url;&pseudo=$pseudo&email=$email;401"
test6="$url;&pseudo=$pseudo&email=;401"
test7="$url;&pseudo=$pseudoshort&email=$email;401"
test8="$url;&pseudo=$pseudobad1&email=$email;401"
test9="$url;&pseudo=$pseudobad2&email=$email;401"
test10="$url;&pseudo=$pseudolong&email=$email;401"
test11="$url;&pseudo=$pseudo&email=$emailbad;401"
test12="$url;&pseudo=$pseudo&email=$email;200"
test13="$url;&pseudo=$pseudo&email=$email;401"
test14="login;&pseudo=$pseudo;200"
test15="logout;&;200"
